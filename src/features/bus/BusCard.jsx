...
export default function BusCard({ bus, recommended }) {
  ...
  return (
    <motion.article layout whileHover={{ y: -4 }} className={`grid gap-4 rounded-[26px] border bg-white p-5 shadow-sm transition sm:grid-cols-[1fr_auto_auto] sm:items-center ${recommended ? 'border-blue-300 shadow-blue-100/80' : 'border-slate-200'}`}>
